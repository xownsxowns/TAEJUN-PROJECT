...
W1 = tf.get_variable('w1_he',[6,30], initializer = tf.contrib.layers.variance_scaling_initializer())
W2 = tf.get_variable('w2_he',[30,24], initializer = tf.contrib.layers.variance_scaling_initializer())
W3 = tf.get_variable('w3_he',[24,12], initializer = tf.contrib.layers.variance_scaling_initializer())
W4 = tf.get_variable('w4_he',[12,8], initializer = tf.contrib.layers.variance_scaling_initializer())
W5 = tf.get_variable('w5_he',[8,2], initializer = tf.contrib.layers.variance_scaling_initializer())
