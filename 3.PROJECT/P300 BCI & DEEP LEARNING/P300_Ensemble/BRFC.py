...
for isub in range(30,60):
    ...
    clf = BalancedRandomForestClassifier(random_state=5)
...
filename = 'P300_Result_BRFC.csv'
df.to_csv(filename)

df2 = pd.DataFrame(train_score)
filename = 'P300_Result_BRFC_trainscore.csv'
df2.to_csv(filename)

df3 = pd.DataFrame(train_score_prob)
filename = 'P300_Result_BRFC_trainscore_prob.csv'
df3.to_csv(filename)