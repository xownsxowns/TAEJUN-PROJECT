...
for repeat_num in range(1,6):
    ...
    for isub in range(30,60):
        ...
        model_name = 'E:/[9] 졸업논문/model/feature_extraction/SAE/model_SAE_t' + str(repeat_num) + '_train' + str(isub + 1) + '.h5'
    ...
    for isub in range(14):
        ...
        model_name = 'E:/[9] 졸업논문/model/feature_extraction/SAE/model_BS_SAE_t' + str(repeat_num) + '_train' + str(isub + 1) + '.h5'
    ...
    filename = 'P300_Result_SAE_' + 't' + str(repeat_num) + '.csv'
    df.to_csv(filename)