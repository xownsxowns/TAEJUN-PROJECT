...
for isub in range(10):
    print(isub+1)
    path = 'E:/[1] Experiment/[1] BCI/P300LSTM/Epoch_data/Epoch_AC/Sub' + str(isub+1) + '_EP_training.mat'
    ...
    ## Test
    path = 'E:/[1] Experiment/[1] BCI/P300LSTM/Epoch_data/Epoch_AC/Sub' + str(isub+1) + '_EP_test.mat'
    # path = '/Volumes/TAEJUN_USB/현차_기술과제데이터/Epoch/Sub' + str(isub + 1) + '_EP_test.mat'
    # path = '/Volumes/UNTITLED2/Epoch_data/Epoch_AC/Sub' + str(isub+1) + '_EP_test.mat'
...
filename = 'P300_Result_NO_AC.csv'
df.to_csv(filename)

df2 = pd.DataFrame(train_score)
filename = 'P300_Result_no_AC_trainscore.csv'
df2.to_csv(filename)
