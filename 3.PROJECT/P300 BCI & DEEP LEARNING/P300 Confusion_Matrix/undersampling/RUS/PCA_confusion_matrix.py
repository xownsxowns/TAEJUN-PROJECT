...
for isub in range(30,60):
    ...
    sam = RandomUnderSampler(random_state=5)
    print(isub+1)
    ...
    data_res, y_res = sam.fit_resample(new_train_data, train_label)
    ...
    for i in range(ntest):
        ...
        for j in range(4):
            ...
            new_test_data = np.dot(new_test_data, np.transpose(pca.components_))
    ...
    filename = 'C:/Users/jhpark/Documents/GitHub/TAEJUN PROJECT/[3]PROJECT/P300 BCI & DEEP LEARNING/P300_sampling/UnderSampling' \
               '/CONFUSION/RUS/PCA_confusion_' + str(isub+1) + '.csv'
    df.to_csv(filename)
...
for isub in range(14):
    ...
    filename = 'C:/Users/jhpark/Documents/GitHub/TAEJUN PROJECT/[3]PROJECT/P300 BCI & DEEP LEARNING/P300_sampling/UnderSampling/CONFUSION/RUS' \
                '/PCA_BS_confusion_' + str(isub + 1) + '.csv'
    df.to_csv(filename)