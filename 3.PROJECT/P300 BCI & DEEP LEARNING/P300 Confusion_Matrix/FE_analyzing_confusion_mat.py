...
for isub in range(30,60):
    ...
    for repeat_num in range(1,11):
        filename = 'C:/Users/jhpark/Documents/GitHub/TAEJUN PROJECT/[3]PROJECT/P300 BCI & DEEP LEARNING/P300_FeatureExtraction/CNN result/' \
    ...
    filename = 'C:/Users/jhpark/Documents/GitHub/TAEJUN PROJECT/[3]PROJECT/P300 BCI & DEEP LEARNING/P300_FeatureExtraction/CNN result/' \
               'confusion matrix/P300_Result_CNN_total_confusion_' + str(isub + 1) + '.csv'
    df1.to_csv(filename)

    df2 = pd.DataFrame(mean_confusion_matrix)
    filename = 'C:/Users/jhpark/Documents/GitHub/TAEJUN PROJECT/[3]PROJECT/P300 BCI & DEEP LEARNING/P300_FeatureExtraction/CNN result/' \
               'confusion matrix/P300_Result_CNN_mean_confusion_' + str(isub + 1) + '.csv'
    df2.to_csv(filename)
...
for isub in range(14):
    ...
    df1 = pd.DataFrame(confusion_matrix)
    filename = 'C:/Users/jhpark/Documents/GitHub/TAEJUN PROJECT/[3]PROJECT/P300 BCI & DEEP LEARNING/P300_FeatureExtraction/CNN result/' \
               'confusion matrix/P300_Result_CNN_BS_total_confusion_' + str(isub + 1) + '.csv'
    df1.to_csv(filename)

    df2 = pd.DataFrame(mean_confusion_matrix)
    filename = 'C:/Users/jhpark/Documents/GitHub/TAEJUN PROJECT/[3]PROJECT/P300 BCI & DEEP LEARNING/P300_FeatureExtraction/CNN result/' \
               'confusion matrix/P300_Result_CNN_BS_mean_confusion_' + str(isub + 1) + '.csv'
    df2.to_csv(filename)
