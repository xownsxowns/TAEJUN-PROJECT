...
label.head()
# label이 1인 index 찾기
index_1 = label[label['label']==1].index
label_1 = np.ones((np.shape(index_1)))
...
print(model.summary())
model.fit(eeg_1, label_1, epochs=100, batch_size=20, verbose=2)


# with a Sequential model
get_3rd_layer_output = K.function([model.layers[0].input],
                                  [model.layers[1].output])
layer_output = get_3rd_layer_output([eeg_1])[0]
