...
for isub in range(30,60):
    ...
    model_name = 'E:/[9] 졸업논문/model/feature_extraction/CNN_2d(full ch)/model_CNN_2d_fullch_train' + str(
        isub + 1) + '.h5'
    ...
    filename = 'C:/Users/jhpark/Documents/GitHub/Python_project/[3]PROJECT/P300 BCI & DEEP LEARNING/P300_FeatureExtraction/CONFUSION/' \
               '/P300_Result_CNN_2D_fullch_confusion_' + str(isub + 1) + '.csv'
    df.to_csv(filename)
...
for isub in range(14):
    ...
    df = pd.DataFrame(confusion_mat)
    filename = 'C:/Users/jhpark/Documents/GitHub/Python_project/[3]PROJECT/P300 BCI & DEEP LEARNING/P300_FeatureExtraction/CONFUSION/' \
               '/P300_Result_BS_CNN_2d_fullch_confusion_' + str(isub + 1) + '.csv'
    df.to_csv(filename)
