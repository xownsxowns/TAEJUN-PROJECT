...
for isub in range(30,60):
    print(isub)
    model_name = 'E:/[9] 졸업논문/model/feature_extraction/ConvLSTM/model_LSTM_CNN_train' + str(
        isub + 1) + '.h5'
    ...
    filename = 'C:/Users/jhpark/Documents/GitHub/Python_project/[3]PROJECT/P300 BCI & DEEP LEARNING/P300_FeatureExtraction/CONFUSION/' \
               '/P300_Result_ConvLSTM_confusion_' + str(isub + 1) + '.csv'
    df.to_csv(filename)
...
for isub in range(14):
    print(isub)
    model_name = 'E:/[9] 졸업논문/model/feature_extraction/ConvLSTM/model_BS_LSTM_CNN_train' + str(
        isub + 1) + '.h5'
    model = load_model(model_name)
    ...
    df = pd.DataFrame(confusion_mat)
    filename = 'C:/Users/jhpark/Documents/GitHub/Python_project/[3]PROJECT/P300 BCI & DEEP LEARNING/P300_FeatureExtraction/CONFUSION/' \
               '/P300_Result_BS_ConvLSTM_confusion_' + str(isub + 1) + '.csv'
    df.to_csv(filename)
