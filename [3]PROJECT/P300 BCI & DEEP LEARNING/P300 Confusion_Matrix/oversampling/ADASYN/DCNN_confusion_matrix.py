...
for repeat_num in range(1,2):
    ...
    for isub in range(30,60):
        ...
        model_name = 'E:/[9] 졸업논문/model/oversampling/ADASYN/DCNN/model_DCNN_adasyn_t' + str(repeat_num) + '_train' + str(isub + 1) + '.h5'
        ...
        for i in range(ntest):
            ...
            for j in range(4):
                ...
                predicted_class = resnet50.predict_classes(test_data)
    ...
    for isub in range(14):
        adasyn = ADASYN(random_state=5)
        model_name = 'E:/[9] 졸업논문/model/oversampling/ADASYN/DCNN/model_BS_DCNN_adasyn_t' + str(repeat_num) + '_train' + str(isub + 1) + '.h5'
