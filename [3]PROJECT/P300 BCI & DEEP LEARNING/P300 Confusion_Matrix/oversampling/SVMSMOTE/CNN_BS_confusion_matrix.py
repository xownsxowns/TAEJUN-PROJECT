...
for repeat_num in range(1,11):
    for isub in range(14):
        ...
        model_name = 'E:/[9] 졸업논문/model/oversampling/SVMSMOTE/model_BS_CNN_svmsmote_t' + str(repeat_num) + '_train' + str(isub + 1) + '.h5'
        ...
        filename = 'C:/Users/jhpark/Documents/GitHub/Python_project/[3]PROJECT/P300 BCI & DEEP LEARNING/P300_sampling/OverSampling/result/CONFUSION/SVMSMOTE/' \
