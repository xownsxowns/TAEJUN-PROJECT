...
for isub in range(30,60):
    ...
    filename = 'C:/Users/jhpark/Documents/GitHub/Python_project/[3]PROJECT/P300 BCI & DEEP LEARNING/P300_sampling/OverSampling/result' \
               '/CONFUSION/SVMSMOTE/P300_Result_SVM_confusion_' + str(isub+1) + '.csv'
    df.to_csv(filename)
