...
for isub in range(30,60):
    ...
    filename = 'C:/Users/jhpark/Documents/GitHub/Python_project/[3]PROJECT/P300 BCI & DEEP LEARNING/P300_sampling/UnderSampling' \
               '/CONFUSION/Tomek/PCA_confusion_' + str(isub+1) + '.csv'
    df.to_csv(filename)
