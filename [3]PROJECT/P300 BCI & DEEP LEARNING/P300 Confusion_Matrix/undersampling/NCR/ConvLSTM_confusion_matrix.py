...
for repeat_num in range(1,2):
    ...
    for isub in range(30,60):
        ...
        model_name = 'E:/[9] 졸업논문/model/undersampling/NCR/ConvLSTM/model_CNN_LSTM_ncr_t' + str(repeat_num) + '_train' + str(isub + 1) + '.h5'
    ...
    for isub in range(14):
        adasyn = NeighbourhoodCleaningRule()
        model_name = 'E:/[9] 졸업논문/model/undersampling/NCR/ConvLSTM/model_BS_CNN_LSTM_ncr_t' + str(repeat_num) + '_train' + str(isub + 1) + '.h5'
        model = load_model(model_name)
