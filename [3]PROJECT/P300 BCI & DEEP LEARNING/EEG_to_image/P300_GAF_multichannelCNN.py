...
for isub in range(60):
    ...
    input_shape = (64, 64, (nch*3))
    model = define_model(input_shape=input_shape)
    model.fit([train_data,train_data,train_data,train_data,train_data,train_data,
               train_data,train_data,train_data,train_data,train_data,train_data,
               train_data,train_data,train_data,train_data,train_data,train_data,
               train_data,train_data,train_data,train_data,train_data,train_data,
               train_data,train_data,train_data,train_data,train_data,train_data], train_label, epochs=500, batch_size=20)
    ## Test
