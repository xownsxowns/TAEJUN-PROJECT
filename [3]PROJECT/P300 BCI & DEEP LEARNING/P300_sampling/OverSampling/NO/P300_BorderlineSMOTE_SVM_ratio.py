...
ratio_num = 8
bsmote_ratio = [(60/150), (70/150), (80/150), (90/150), (100/150), (110/150), (120/150), (130/150), (140/150)]
bs_bsmote_ratio = [(70/250), (90/250), (110/250), (130/250), (150/250), (170/250), (190/250), (210/250), (230/250)]

for isub in range(30,60):
    sm = BorderlineSMOTE(random_state=5, sampling_strategy=bsmote_ratio[ratio_num])
    print(isub)
    ...
    filename = 'C:/Users/jhpark/Documents/GitHub/Python_project/[3]PROJECT/P300 BCI & DEEP LEARNING/P300_FeatureExtraction/CONFUSION/' \
               'P300_Result_SVM_bsmote_ratio' + str(ratio_num) + '_confusion_' + str(isub + 1) + '_train.csv'
    df.to_csv(filename)
    ...
    filename = 'C:/Users/jhpark/Documents/GitHub/Python_project/[3]PROJECT/P300 BCI & DEEP LEARNING/P300_FeatureExtraction/CONFUSION/' \
                   'P300_Result_SVM_bsmote_ratio' + str(ratio_num) + '_confusion_' + str(isub+1) + '.csv'
...
for isub in range(14):
    ...
    df = pd.DataFrame(cm)
    filename = 'C:/Users/jhpark/Documents/GitHub/Python_project/[3]PROJECT/P300 BCI & DEEP LEARNING/P300_FeatureExtraction/CONFUSION/' \
               'P300_Result_BS_SVM_bsmote_ratio' + str(ratio_num) + '_confusion_' + str(isub + 1) + '_train.csv'
    df.to_csv(filename)
    ...
    df = pd.DataFrame(confusion_mat)
    filename = 'C:/Users/jhpark/Documents/GitHub/Python_project/[3]PROJECT/P300 BCI & DEEP LEARNING/P300_FeatureExtraction/CONFUSION/' \
                   'P300_Result_BS_SVM_bsmote_ratio' + str(ratio_num) + '_confusion_' + str(isub+1) + '.csv'
    df.to_csv(filename)
...
filename = 'P300_Result_SVM_borderline_smote_ratio' + str(ratio_num) + '.csv'
df.to_csv(filename)

df2 = pd.DataFrame(train_score)
filename = 'P300_Result_SVM_borderline_smote_ratio' + str(ratio_num) + '_trainscore.csv'
df2.to_csv(filename)