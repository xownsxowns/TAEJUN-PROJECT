...
for isub in range(30,60):
    ...
    model_name = 'E:/[9] 졸업논문/model/oversampling/model_CNN_smote_train' + str(isub + 1) + '.h5'
...
for isub in range(14):
    ...
    model_name = 'E:/[9] 졸업논문/model/oversampling/model_BS_CNN_smote_train' + str(isub + 1) + '.h5'
    model.save(model_name)
...
filename = 'P300_Result_CNN_smote.csv'
df.to_csv(filename)

df2 = pd.DataFrame(train_score)
filename = 'P300_Result_CNN_smote_trainscore.csv'
df2.to_csv(filename)

df3 = pd.DataFrame(train_score_prob)
filename = 'P300_Result_CNN_smote_trainscore_prob.csv'
df3.to_csv(filename)