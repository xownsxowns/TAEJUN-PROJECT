...
for repeat_num in range(1,2):
    ...
    for isub in range(30,60):
        ...
        model_name = 'E:/[9] 졸업논문/model/oversampling/ADASYN/CNN2D Full ch/model_CNN2D_fullch_adasyn_t' + str(repeat_num) + '_train' + str(isub + 1) + '.h5'
    ...
    for isub in range(14):
        ...
        model_name = 'E:/[9] 졸업논문/model/oversampling/ADASYN/CNN2D Full ch/model_BS_CNN2D_fullch_adasyn_t' + str(repeat_num) + '_train' + str(isub + 1) + '.h5'
        model.save(model_name)
