...
for repeat_num in range(1,6):
    ...
    for isub in range(30,60):
        ...
        model_name = '//192.168.1.181/office/[04] 연구원개인문서함/이태준/[9] 졸업논문/model/oversampling/SVMSMOTE/SAE/model_SAE_svmsmote_t' + str(repeat_num) + '_train' + str(isub + 1) + '.h5'
    ...
    for isub in range(14):
        ...
        model_name = '//192.168.1.181/office/[04] 연구원개인문서함/이태준/[9] 졸업논문/model/oversampling/SVMSMOTE/SAE/model_BS_SAE_svmsmote_t' + str(repeat_num) + '_train' + str(isub + 1) + '.h5'
    ...
    filename = 'P300_Result_SAE_svmsmote_t' + str(repeat_num) + '.csv'
    df.to_csv(filename)

    df2 = pd.DataFrame(train_score)
    filename = 'P300_Result_SAE_svmsmote_t' + str(repeat_num) + '_trainscore.csv'
    df2.to_csv(filename)