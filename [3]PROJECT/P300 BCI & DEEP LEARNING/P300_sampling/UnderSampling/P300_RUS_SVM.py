...
for isub in range(30,60):
    ...
    data_res, y_res = rus.fit_resample(reshape_data, train_label)
...
filename = 'P300_Result_SVM_rus.csv'
df.to_csv(filename)

df2 = pd.DataFrame(train_score)
filename = 'P300_Result_SVM_rus_trainscore.csv'
df2.to_csv(filename)

df3 = pd.DataFrame(train_score_prob)
filename = 'P300_Result_SVM_rus_trainscore_prob.csv'
df3.to_csv(filename)