...
for repeat_num in range(1, 6):
    ...
    for isub in range(30, 60):
        ...
        model_name = '//192.168.1.181/office/[04] 연구원개인문서함/이태준/[9] 졸업논문/model/undersampling/NCR/CNN2D Full ch/model_CNN2D_fullch_ncr_t' + str(
    ...
    for isub in range(14):
        ...
        model_name = '//192.168.1.181/office/[04] 연구원개인문서함/이태준/[9] 졸업논문/model/undersampling/NCR/CNN2D Full ch/model_BS_CNN2D_fullch_ncr_t' + str(
            repeat_num) + '_train' + str(isub + 1) + '.h5'
        model.save(model_name)
    ...
    filename = 'P300_Result_CNN2D_fullch_ncr_t' + str(repeat_num) + '.csv'
    df.to_csv(filename)

    df2 = pd.DataFrame(train_score)
    filename = 'P300_Result_CNN2D_fullch_ncr_t' + str(repeat_num) + '_trainscore.csv'
    df2.to_csv(filename)
