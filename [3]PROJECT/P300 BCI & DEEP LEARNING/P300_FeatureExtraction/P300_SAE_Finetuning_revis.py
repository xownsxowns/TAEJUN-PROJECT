...
for isub in range(50,60):
    ...
    model_name = 'E:/[9] 졸업논문/model/model_SAE2_train'+str(isub+1)+'.h5'
...
for isub in range(14):
    ...
    model_name = 'E:/[9] 졸업논문/model/model_BS_SAE2_train'+str(isub+1)+'.h5'
...
filename = 'P300_Result_SAE_FEv2_2.csv'
df.to_csv(filename)