...
for isub in range(30,60):
    ...
    xdwn = XdawnCovariances(estimator='scm', nfilter=4)
    train_data = xdwn.fit(train_data, train_label).transform(train_data)
...
filename = 'P300_Result_NO_xDAWN.csv'
df.to_csv(filename)
...
# filename = 'P300_Result_no_trainscore_prob.csv'
# df3.to_csv(filename)