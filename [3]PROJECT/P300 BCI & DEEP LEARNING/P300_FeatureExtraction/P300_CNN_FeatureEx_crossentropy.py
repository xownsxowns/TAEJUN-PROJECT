...
for isub in range(30,60):
    ...
    model_name = 'E:/[9] 졸업논문/model/model_CNN_entropy_train' + str(isub + 1) + '.h5'
...
for isub in range(14):
    ...
    model_name = 'E:/[9] 졸업논문/model/model_BS_CNN_entropy_train' + str(isub + 1) + '.h5'
    model.save(model_name)
    ## classifier
...
filename = 'P300_Result_CNN_crossentropy.csv'
df.to_csv(filename)