...
for sub_num in range(2,52):
    for stim_num in range(0,2):
        ############################################################
        # sub_num = 1
        # base: 0, stim: 1
        # stim_num = 0
        ...
        video_path = 'D:/현대차 힐링 영상/sub' + str(sub_num) + '_' + stim[stim_num] + '.avi'
        print(video_path)
        ...
        score_save = pd.DataFrame(score)

        filename = 'D:/현대차 힐링 영상/sub' + str(sub_num) + '_' + stim[stim_num] + '.csv'
        score_save.to_csv(filename)
