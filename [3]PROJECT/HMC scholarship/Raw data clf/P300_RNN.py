...
from keras.layers import Dense, Dropout, Flatten, LSTM, Conv2D, MaxPooling2D, SimpleRNN
...
for isub in range(60):
    ...
    model = Sequential()
    model.add(SimpleRNN(20, input_shape=(nlen, nch), activation='relu'))
